...
def config(
    ...
    revert_enabled: bool = typer.Option(
        False,
        help="Enable the revert mechanism.",
    ),
    max_retries: int = typer.Option(
        3,
        help="Maximum number of retries per set of functions.",
    ),
    incremental_step_size: int = typer.Option(
        1,
        help="Number of functions to implement per incremental step.",
    ),
